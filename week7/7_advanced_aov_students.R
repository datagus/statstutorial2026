...
#     The content is originally human. The script was revised by the tutors
#==================================================================
...
#                     + Error(block))
#
#      C)  aov(yield ~ irrigation + density + fertilizer
#                     + irrigation:density
#                     + irrigation:fertilizer
#                     + Error(block))
#
...
#      C)  Fertilizer choice and irrigation should be decided
...
#      C)  Yield differs across blocks, suggesting that field-to-field
...
#      B)  evil_m3 gives fertilizer a more favorable test,
...
#      B)  The design is unbalanced — some factor combinations have
...
#      B)  No — the interaction is not significant; each design
...
#      B)  No — n_gears is not significant in model_6; it does not
...
#      B)  Automatic transmission with a V-shaped engine — both
